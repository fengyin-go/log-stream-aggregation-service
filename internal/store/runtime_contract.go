...
func (s *NotificationReadVersionStore) Update(key string, version int, state string) bool { s.mu.Lock(); defer s.mu.Unlock(); s.states[key] = VersionedState{Version: version, State: state}; return true }
