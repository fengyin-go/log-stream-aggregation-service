...
func (p *IndexReaderLeasePool) Acquire() (*IndexReaderLeaseLease, error) { p.mu.Lock(); defer p.mu.Unlock(); p.open++; if p.open > p.limit { return nil, errors.New("lease limit") }; return &IndexReaderLeaseLease{pool: p}, nil }
